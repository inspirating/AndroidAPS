...
class DanaPenPacketBolusGetCirCfArrayTest : DanaPENTestBase() {

    private val packetInjector = HasAndroidInjector {
        AndroidInjector {
            if (it is DanaPENPacketBolusGetCIRCFArray) {
    ...
    @Test fun runTest() {
        val packet = DanaPENPacketBolusGetCIRCFArray(packetInjector)
        // test params
