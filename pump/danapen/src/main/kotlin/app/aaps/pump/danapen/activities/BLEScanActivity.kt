package app.aaps.pump.danapen.activities
...
import app.aaps.pump.danapen.R
import app.aaps.pump.danapen.databinding.DanapenBlescannerActivityBinding
...
class BLEScanActivity : TranslatedDaggerAppCompatActivity() {
    ...
    private lateinit var binding: DanapenBlescannerActivityBinding

    @SuppressLint("SourceLockedOrientationActivity")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DanapenBlescannerActivityBinding.inflate(layoutInflater)
    ...
    internal inner class ListAdapter : BaseAdapter() {
        ...
        override fun getView(i: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            if (v == null) {
                v = View.inflate(applicationContext, R.layout.danapen_blescanner_item, null)
                holder = ViewHolder(v)
                v.tag = holder
            } else {
