package app.aaps.pump.danapen.dialogs
...
import app.aaps.pump.danapen.databinding.DanapenPairingProgressDialogBinding
...
class PairingProgressDialog : DaggerDialogFragment() {
    ...
    private var _binding: DanapenPairingProgressDialogBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DanapenPairingProgressDialogBinding.inflate(inflater, container, false)
    ...
    override fun onResume() {
        super.onResume()
        disposable += rxBus
            .toObservable(EventDanaPENPairingSuccess::class.java)
