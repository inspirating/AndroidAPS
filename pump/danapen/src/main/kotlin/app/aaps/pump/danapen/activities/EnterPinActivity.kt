...
import app.aaps.pump.danapen.databinding.DanapenEnterPinActivityBinding
import app.aaps.pump.danapen.services.BLEComm
...
class EnterPinActivity : TranslatedDaggerAppCompatActivity() {
    ...
    private lateinit var binding: DanapenEnterPinActivityBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DanapenEnterPinActivityBinding.inflate(layoutInflater)
