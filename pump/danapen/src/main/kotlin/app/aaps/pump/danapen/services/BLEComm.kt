...
class BLEComm @Inject internal constructor(
    ...
    private fun processConnectResponse(decryptedBuffer: ByteArray) {
        ...
        if (decryptedBuffer.size == 4 && decryptedBuffer[2] == 'O'.code.toByte() && decryptedBuffer[3] == 'K'.code.toByte()) {
            ...
            val pairingKey = preferences.get(DanaString2Key.DanaRsParingKey, danaPENPlugin.mDeviceName)
            ...
            // grab randomSyncKey
            preferences.put(DanaString2Key.DanaRsV3RandomSyncKey, danaPENPlugin.mDeviceName, String.format("%02x", decryptedBuffer[decryptedBuffer.size - 1]))
        ...
        // response OK BLE5
            ...
            if (decryptedBuffer[8] != 0.toByte())
                preferences.put(DanaString2Key.DanaRsBle5PairingKey, danaPENPlugin.mDeviceName, pairingKey)

            val storedPairingKey = preferences.get(DanaString2Key.DanaRsBle5PairingKey, danaPENPlugin.mDeviceName)
    ...
    private fun processPairingRequest2(decryptedBuffer: ByteArray) {
        ...
        preferences.put(DanaString2Key.DanaRsParingKey, danaPENPlugin.mDeviceName, DanaPENPacket.bytesToHex(pairingKey))
