...
class DanaPenPacketOptionGetPumpTimeTest : DanaPENTestBase() {
    ...
    private val packetInjector = HasAndroidInjector {
        AndroidInjector {
            ...
            if (it is DanaPENPacketOptionGetPumpTime) {
    ...
    @Test fun runTest() {
        val packet = DanaPENPacketOptionGetPumpTime(packetInjector)
